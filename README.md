...
[![Docs](https://img.shields.io/badge/Docs-CoinEx.Net-1b7f50?style=for-the-badge)](https://cryptoexchange.jkorf.dev/docs/exchange-clients?library=CoinEx.Net)
...
The [CoinEx.Net documentation](https://cryptoexchange.jkorf.dev/docs/exchange-clients?library=CoinEx.Net) is the main resource for installing, configuring, and using the library.

| Resource | Description |
|--|--|
| [Client guide](https://cryptoexchange.jkorf.dev/docs/exchange-clients?library=CoinEx.Net) | Installation, REST and WebSocket clients, authentication, dependency injection, error handling, and advanced features |
| [Examples](https://cryptoexchange.jkorf.dev/docs/exchange-clients/examples?library=CoinEx.Net) | Common REST and WebSocket operations |
| [API reference](https://cryptoexchange.jkorf.dev/docs/exchange-clients/reference?library=CoinEx.Net) | Client interfaces, methods, and properties |
...
For more examples and explanations, continue with the [CoinEx.Net documentation](https://cryptoexchange.jkorf.dev/docs/exchange-clients?library=CoinEx.Net) or browse the [compilable repository examples](https://github.com/JKorf/CoinEx.Net/tree/master/Examples).
...
|File|Purpose|
|--|--|
|[`AGENTS.md`](AGENTS.md)|Assistant skill with core CoinEx.Net patterns, pitfalls, and examples|
...
V2 uses a strict interface per capability. The `SharedApi` property on each API surface therefore exposes only the operations or subscriptions that surface actually supports. `ICoinExSharedApiClient` groups the exchange's Shared API surfaces for dependency injection and runtime capability lookup.
...
using var restClient = new CoinExRestClient();
IGetTickerRest tickerClient = restClient.SpotApiV2.SharedApi;
...
## Release notes
* Version 11.5.0 - 24 Sep 2026
    * Updated CryptoExchange.Net to v13.0.0
    * Shared APIs
      * Added SharedApi V2 support
      * Added `.SharedApi` property to clients
      * Added `(I)CoinExSharedApiClient` containing all V2 SharedApi references
      * Added `SharedApi` to `CoinExOptions` to provide SharedApi related options
    ...
    * Added reduceOnly parameter to FuturesApi.Trading.PlaceStopOrderAsync and PlaceStopOrderAsync endpoint
    * Added positionSide and stopMode parameters to FuturesApi.Trading.ClosePositionAsync endpoint
...
* Version 11.4.0 - 21 Aug 2026
    ...
    * Added MakerFeePercentage, TakerFeePercentage to SharedSpotSymbol

* Version 11.3.0 - 29 Jul 2026
...
* Version 11.0.0 - 29 Jun 2026
    ...
    * Added setter to CoinExExchange.RateLimiter to allow custom rate limit settings
