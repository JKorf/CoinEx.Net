...
namespace CoinEx.Net.UnitTests
{
    ...
    public class RestRequestTests
    {
        ...
        public async Task ValidateFuturesTradingCalls()
        {
            ...
            await tester.ValidateAsync(client => client.FuturesApi.Trading.EditStopLossAsync("ETHUSDT", 123, Enums.PriceType.LastPrice, 1), "EditStopLoss");
            await tester.ValidateAsync(client => client.FuturesApi.Trading.CancelStopLossAsync("ETHUSDT", 123), "CancelStopLoss");
            ...
            await tester.ValidateAsync(client => client.FuturesApi.Trading.EditTakeProfitAsync("ETHUSDT", 123, Enums.PriceType.LastPrice, 1), "EditTakeProfit", ignoreProperties: ["base_fee", "quote_fee", "discount_fee", "maker_fee_rate", "taker_fee_rate"]);
            await tester.ValidateAsync(client => client.FuturesApi.Trading.CancelTakeProfitAsync("ETHUSDT", 123), "CancelTakeProfit");
