...
namespace CoinEx.Net
{
    ...
    public class CoinExClient : RestClient, ICoinExClient
    {
        ...
        public WebCallResult<IEnumerable<string>> GetMarketList(CancellationToken ct = default) => GetMarketListAsync(ct).Result;
        /// <summary>
        /// Gets a list of markets active on CoinEx
        /// </summary>
        /// <returns>List of market names</returns>
        public async Task<WebCallResult<IEnumerable<string>>> GetMarketListAsync(CancellationToken ct = default)
        {
        ...
        public WebCallResult<CoinExMarketState> GetMarketState(string market, CancellationToken ct = default) => GetMarketStateAsync(market, ct).Result;
        /// <summary>
        /// Gets the state of a specific market
        /// </summary>
        /// <param name="market">The market to retrieve state for</param>
        /// <param name="ct">Cancellation token</param>
        /// <returns>The state of the market</returns>
        public async Task<WebCallResult<CoinExMarketState>> GetMarketStateAsync(string market, CancellationToken ct = default)
        {
            ...
            return await Execute<CoinExMarketState>(GetUrl(MarketStatisticsEndpoint), HttpMethod.Get, ct, parameters).ConfigureAwait(false);
        }
        ...
        public WebCallResult<CoinExMarketStatesList> GetMarketStates(CancellationToken ct = default) => GetMarketStatesAsync(ct).Result;
        /// <summary>
        /// Gets the states of all markets
        /// </summary>
        /// <param name="ct">Cancellation token</param>
        /// <returns>List of states for all markets</returns>
        public async Task<WebCallResult<CoinExMarketStatesList>> GetMarketStatesAsync(CancellationToken ct = default)
        {
            return await Execute<CoinExMarketStatesList>(GetUrl(MarketStatisticsListEndpoint), HttpMethod.Get, ct).ConfigureAwait(false);
        }
        ...
        public WebCallResult<CoinExMarketDepth> GetMarketDepth(string market, int mergeDepth, int? limit = null, CancellationToken ct = default) => 
            GetMarketDepthAsync(market, mergeDepth, limit, ct).Result;
        /// <summary>
        /// Gets the depth data for a market
        /// </summary>
        /// <param name="market">The market to retrieve depth data for</param>
        ...
        /// <param name="ct">Cancellation token</param>
        /// <returns>Depth data for a market</returns>
        public async Task<WebCallResult<CoinExMarketDepth>> GetMarketDepthAsync(string market, int mergeDepth, int? limit = null, CancellationToken ct = default)
        {
            ...
            return await Execute<CoinExMarketDepth>(GetUrl(MarketDepthEndpoint), HttpMethod.Get, ct, parameters).ConfigureAwait(false);
        }
        ...
        public WebCallResult<IEnumerable<CoinExMarketTransaction>> GetLatestTransactions(string market, long? fromId = null, CancellationToken ct = default) => 
            GetLatestTransactionsAsync(market, fromId, ct).Result;
        /// <summary>
        /// Gets the latest transactions for a market
        /// </summary>
        /// <param name="market">The market to retrieve data for</param>
        ...
        /// <param name="ct">Cancellation token</param>
        /// <returns>List of transactions for a market</returns>
        public async Task<WebCallResult<IEnumerable<CoinExMarketTransaction>>> GetLatestTransactionsAsync(string market, long? fromId = null, CancellationToken ct = default)
        {
            var parameters = new Dictionary<string, object>
            {
                { "market", market }
            ...
            return await Execute<IEnumerable<CoinExMarketTransaction>>(GetUrl(MarketDealsEndpoint), HttpMethod.Get, ct, parameters).ConfigureAwait(false);
        }
        ...
        public WebCallResult<IEnumerable<CoinExKline>> GetKlines(string market, KlineInterval interval, int? limit = null, CancellationToken ct = default) => GetKlinesAsync(market, interval, limit, ct).Result;
        /// <summary>
        /// Retrieves kline data for a specific market
        /// </summary>
        /// <param name="market">The market to retrieve klines for</param>
        ...
        /// <param name="ct">Cancellation token</param>
        /// <returns>List of klines for a market</returns>
        public async Task<WebCallResult<IEnumerable<CoinExKline>>> GetKlinesAsync(string market, KlineInterval interval, int? limit = null, CancellationToken ct = default)
        {
            var parameters = new Dictionary<string, object>
            {
                { "market", market },
        ...
        public WebCallResult<CoinExOrder> PlaceLimitOrder(string market, TransactionType type, decimal amount, decimal price, string? sourceId = null, CancellationToken ct = default) =>
            PlaceLimitOrderAsync(market, type, amount, price, sourceId, ct).Result;
        /// <summary>
        /// Places a limit order. Requires API credentials
        /// </summary>
        /// <param name="market">The market to place the order for</param>
        ...
        /// <param name="ct">Cancellation token</param>
        /// <returns>Details of the order that was placed</returns>
        public async Task<WebCallResult<CoinExOrder>> PlaceLimitOrderAsync(string market, TransactionType type, decimal amount, decimal price, string? sourceId = null, CancellationToken ct = default)
        {
            var parameters = new Dictionary<string, object>
            {
                { "market", market },
        ...
        /// <param name="ct">Cancellation token</param>
        /// <returns>Details of the order that was placed</returns>
        public WebCallResult<CoinExOrder> PlaceMarketOrder(string market, TransactionType type, decimal amount, string? sourceId = null, CancellationToken ct = default) => 
            PlaceMarketOrderAsync(market, type, amount, sourceId, ct).Result;
        /// <summary>
        /// Places a market order. Requires API credentials
        /// </summary>
        /// <param name="market">The market to place the order for</param>
        ...
        /// <param name="ct">Cancellation token</param>
        /// <returns>Details of the order that was placed</returns>
        public async Task<WebCallResult<CoinExOrder>> PlaceMarketOrderAsync(string market, TransactionType type, decimal amount, string? sourceId = null, CancellationToken ct = default)
        {
            var parameters = new Dictionary<string, object>
            {
                { "market", market },
        ...
        /// <param name="ct">Cancellation token</param>
        /// <returns></returns>
        public WebCallResult<CoinExOrder> PlaceImmediateOrCancelOrder(string market, TransactionType type, decimal amount, decimal price, string? sourceId = null, CancellationToken ct = default) => 
            PlaceImmediateOrCancelOrderAsync(market, type, amount, price, sourceId, ct).Result;
        /// <summary>
        /// Places an order which should be filled immediately up on placing, otherwise it will be canceled. Requires API credentials
        /// </summary>
        /// <param name="market">The market to place the order for</param>
        ...
        /// <param name="ct">Cancellation token</param>
        /// <returns></returns>
        public async Task<WebCallResult<CoinExOrder>> PlaceImmediateOrCancelOrderAsync(string market, TransactionType type, decimal amount, decimal price, string? sourceId = null, CancellationToken ct = default)
        {
            var parameters = new Dictionary<string, object>
            {
                { "market", market },
        ...
        public WebCallResult<CoinExPagedResult<CoinExOrder>> GetOpenOrders(string market, int page, int limit, CancellationToken ct = default) => 
            GetOpenOrdersAsync(market, page, limit, ct).Result;
        /// <summary>
        /// Retrieves a list of open orders for a market. Requires API credentials
        /// </summary>
        /// <param name="market">The market to retrieve the open orders for</param>
        ...
        /// <param name="ct">Cancellation token</param>
        /// <returns>List of open orders for a market</returns>
        public async Task<WebCallResult<CoinExPagedResult<CoinExOrder>>> GetOpenOrdersAsync(string market, int page, int limit, CancellationToken ct = default)
        {
            var parameters = new Dictionary<string, object>
            {
                { "market", market },
        ...
        public WebCallResult<CoinExPagedResult<CoinExOrder>> GetExecutedOrders(string market, int page, int limit, CancellationToken ct = default) =>
            GetExecutedOrdersAsync(market, page, limit, ct).Result;
        /// <summary>
        /// Retrieves a list of executed orders for a market in the last 2 days. Requires API credentials
        /// </summary>
        /// <param name="market">The market to retrieve the open orders for</param>
        ...
        /// <param name="ct">Cancellation token</param>
        /// <returns>List of executed orders for a market</returns>
        public async Task<WebCallResult<CoinExPagedResult<CoinExOrder>>> GetExecutedOrdersAsync(string market, int page, int limit, CancellationToken ct = default)
        {
            var parameters = new Dictionary<string, object>
            {
                { "market", market },
        ...
        public WebCallResult<CoinExOrder> GetOrderStatus(long orderId, string market, CancellationToken ct = default) => GetOrderStatusAsync(orderId, market, ct).Result;
        /// <summary>
        /// Retrieves details of an order. Requires API credentials
        /// </summary>
        /// <param name="orderId">The id of the order to retrieve</param>
        ...
        /// <param name="ct">Cancellation token</param>
        /// <returns>Details of the order</returns>
        public async Task<WebCallResult<CoinExOrder>> GetOrderStatusAsync(long orderId, string market, CancellationToken ct = default)
        {
            var parameters = new Dictionary<string, object>
            {
                { "market", market },
        ...
        public WebCallResult<CoinExPagedResult<CoinExOrderTransactionExtended>> GetExecutedTransactions(string market, int page, int limit, CancellationToken ct = default) => 
            GetExecutedTransactionsAsync(market, page, limit, ct).Result;
        /// <summary>
        /// Gets a list of transactions you executed on a specific market. Requires API credentials
        /// </summary>
        /// <param name="market">The market to retrieve transactions for</param>
        ...
        /// <param name="ct">Cancellation token</param>
        /// <returns>List of transaction for a market</returns>
        public async Task<WebCallResult<CoinExPagedResult<CoinExOrderTransactionExtended>>> GetExecutedTransactionsAsync(string market, int page, int limit, CancellationToken ct = default)
        {
            var parameters = new Dictionary<string, object>
            {
                { "market", market },
        ...
        public WebCallResult<CoinExOrder> CancelOrder(string market, long orderId, CancellationToken ct = default) => CancelOrderAsync(market, orderId, ct).Result;
        /// <summary>
        /// Cancels an order. Requires API credentials
        /// </summary>
        /// <param name="market">The market the order is on</param>
        ...
        /// <param name="ct">Cancellation token</param>
        /// <returns>Details of the canceled order</returns>
        public async Task<WebCallResult<CoinExOrder>> CancelOrderAsync(string market, long orderId, CancellationToken ct = default)
        {
            var parameters = new Dictionary<string, object>
            {
                { "market", market },
