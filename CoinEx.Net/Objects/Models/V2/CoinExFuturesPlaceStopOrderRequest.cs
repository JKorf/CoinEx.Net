...
namespace CoinEx.Net.Objects.Models.V2
{
    ...
    /// </summary>
    [SerializationModel]
    public record CoinExFuturesPlaceStopOrderRequest
    {
        /// <summary>
        ...
        /// The trigger price
        /// </summary>
        [JsonPropertyName("trigger_price"), JsonConverter(typeof(CryptoExchange.Net.Converters.SystemTextJson.DecimalStringWriterConverter))]
        public decimal TriggerPrice { get; set; }
        /// <summary>
        /// ["<c>trigger_price_type</c>"] The trigger price type
        /// </summary>
