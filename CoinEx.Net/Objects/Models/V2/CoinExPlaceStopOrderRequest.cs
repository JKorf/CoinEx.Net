...
namespace CoinEx.Net.Objects.Models.V2
{
    ...
    public record CoinExPlaceStopOrderRequest
    {
        ...
        /// The trigger price
        /// </summary>
        [JsonPropertyName("trigger_price"), JsonIgnore(Condition = JsonIgnoreCondition.WhenWritingDefault), JsonConverter(typeof(CryptoExchange.Net.Converters.SystemTextJson.DecimalStringWriterConverter))]
