...
{
    internal class CoinExFuturesOrderBookSubscription : Subscription
    {
        ...
        public CoinExFuturesOrderBookSubscription(ILogger logger, SocketApiClient client, string[] symbols, Dictionary<string, object> parameters, Action<DataEvent<CoinExOrderBook>> handler) : base(logger, false)
        {
            _client = client;
            _symbols = symbols;
