...
{
    internal class CoinExTickerSubscription : Subscription
    {
        ...
        public CoinExTickerSubscription(ILogger logger, SocketApiClient client, string[] symbols, Dictionary<string, object> parameters, Action<DataEvent<CoinExTicker[]>> handler) : base(logger, false)
        {
            _client = client;
            ...
            MessageRouter = MessageRouter.CreateForEvent<CoinExSocketUpdate<CoinExTickerUpdateWrapper>>("state.update", DoHandleMessage);
        }
